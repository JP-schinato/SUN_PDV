...
--
-- Host: 127.0.0.1
-- Tempo de geração: 16/04/2025 às 14:14
...
ALTER TABLE `user_sistema`
  ...
  ADD KEY `ligação entre user e vendas` (`ID_Venda`),
  ADD KEY `ligação com user e produtos` (`ID_Produto`),
  ADD KEY `Ligação entre user e cargo` (`ID_Cargo`);
...
--
ALTER TABLE `login_sistema`
  MODIFY `ID_LOGIN` smallint(6) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `user_sistema`
  ADD CONSTRAINT `Ligação entre user e cargo` FOREIGN KEY (`ID_Cargo`) REFERENCES `cargo` (`ID_Cargo`),
